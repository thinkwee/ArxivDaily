...
def get_content(link):
    ...
    if len(group) == 0:
        ...
        for idx, item in enumerate(group):
            msg_all += "- Title: " + item[0].lstrip("Title:") + "\n"
...
links = [
    "https://arxiv.org/list/cs.CL/pastweek?skip=0&show=100", "https://arxiv.org/list/cs.CV/pastweek?skip=0&show=100",
    "https://arxiv.org/list/cs.CY/pastweek?skip=0&show=100", "https://arxiv.org/list/cs.HC/pastweek?skip=0&show=100",
    "https://arxiv.org/list/cs.IR/pastweek?skip=0&show=100", "https://arxiv.org/list/cs.LG/pastweek?skip=0&show=100",
    "https://arxiv.org/list/cs.MA/pastweek?skip=0&show=100", "https://arxiv.org/list/cs.SE/pastweek?skip=0&show=100",
    "https://arxiv.org/list/cs.NE/pastweek?skip=0&show=100", "https://arxiv.org/list/cs.AI/pastweek?skip=0&show=100"
]
